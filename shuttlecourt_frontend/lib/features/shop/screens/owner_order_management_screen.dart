...
class OwnerOrderManagementScreen extends StatefulWidget {
  ...
  const OwnerOrderManagementScreen({super.key, this.isEmbedded = false});
    ...
    return Scaffold(
      ...
      body: widget.isEmbedded
          ? _isLoading 
              ...
              : _orders.isEmpty
                  ? const Center(child: Padding(padding: EdgeInsets.symmetric(vertical: 40), child: Text('Chưa có đơn hàng nào.')))
                  : _buildOrderList()
          : RefreshIndicator(
