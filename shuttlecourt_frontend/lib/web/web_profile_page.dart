                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text('ĐĂNG NHẬP', style: TextStyle(fontWeight: FontWeight.w800, color: Colors.white)),
                              ),
                            ),
                            const SizedBox(height: 16),
                            TextButton(
                              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const RegisterScreen())),
                              child: const Text('Tạo tài khoản mới', style: TextStyle(color: AppTheme.primary, fontWeight: FontWeight.w700)),
                            ),
                          ],
                        ),
                      ),
                                ...
                                Stack(
                                  children: [
                                    Container(
                                      ...
                                      child: const Icon(Icons.person_rounded, size: 64, color: AppTheme.primary),
                                    ),
                                    Positioned(
                                      bottom: 0, right: 0,
                              ...
                              children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        const Padding(
                                          ...
                                          child: Text('CÀI ĐẶT', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: AppTheme.textMuted, letterSpacing: 1.2)),
                                        ),
                                        if (user.role == 'owner')
                                          _MenuTile(icon: Icons.dashboard_customize_rounded, title: 'Bảng điều khiển', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const OwnerDashboardScreen()))),
                                        _MenuTile(icon: Icons.person_outline_rounded, title: 'Chỉnh sửa hồ sơ', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => EditProfileScreen(user: user)))),
                                        _MenuTile(icon: Icons.shield_outlined, title: 'Bảo mật & Mật khẩu', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SecurityScreen()))),
                                        _MenuTile(icon: Icons.notifications_none_rounded, title: 'Thông báo', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const NotificationSettingsScreen()))),
                                        _MenuTile(icon: Icons.language_rounded, title: 'Ngôn ngữ', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const LanguageSettingsScreen()))),
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: TextButton.icon(
                                              ...
                                              style: TextButton.styleFrom(
                                                ...
                                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12), side: BorderSide(color: AppTheme.error.withOpacity(0.2))),
                                              ),
                                            ),
                                          ),
                                        ),
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      const Text('Tổng quan', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: AppTheme.textPrimary)),
                                      ...
                                      LayoutBuilder(
                                        builder: (context, constraints) {
                                          ...
                                          return GridView.count(
                                            ...
                                            children: const [
                                              _StatCard(title: 'Sân đã đặt', value: '12', icon: Icons.sports_tennis_rounded, color: AppTheme.primary),
                                              _StatCard(title: 'Đánh giá', value: '5', icon: Icons.star_rounded, color: Colors.amber),
                                            ],
                                          );
                                        }
                                      ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            const Icon(Icons.chevron_right_rounded, color: AppTheme.borderLight, size: 20),
          ],
        ),
      ),
    );
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(value, style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: color, height: 1.1)),
