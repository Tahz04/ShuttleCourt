      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              _buildLabel('Tên sân & Khu vực'),
              TextFormField(
                decoration: _inputDecoration('VD: Sân Kỳ Hòa - Quận 10', Icons.stadium_rounded),
                validator: (v) => v!.isEmpty ? 'Vui lòng nhập tên sân' : null,
                onSaved: (v) => _courtName = v!,
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildLabel('Phí dự kiến/người'),
                        TextFormField(
                          initialValue: '35000',
                          keyboardType: TextInputType.number,
                          decoration: _inputDecoration('VNĐ', Icons.payments_rounded),
                          onSaved: (v) => _price = double.tryParse(v!) ?? 35000,
                        ),
                      ],
                    ),
                  ),
